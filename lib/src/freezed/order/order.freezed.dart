...
@JsonKey(name: 'order_id') int get orderId; String get pair; String get side;@JsonKey(name: 'position_side') String? get positionSide; String get type;@JsonKey(name: 'start_amount') String get startAmount;@JsonKey(name: 'remaining_amount') String get remainingAmount;@JsonKey(name: 'executed_amount') String get executedAmount; String get price;@JsonKey(name: 'post_only') bool get postOnly;@JsonKey(name: 'user_cancelable') bool get userCancelable;@JsonKey(name: 'average_price') String get averagePrice;@JsonKey(name: 'ordered_at') int get orderedAt;@JsonKey(name: 'expire_at') int get expireAt;@JsonKey(name: 'triggered_at') int? get triggeredAt;@JsonKey(name: 'trigger_price') String? get triggerPrice; String get status;
...
/// Create a copy of Order
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? orderId = null,Object? pair = null,Object? side = null,Object? positionSide = freezed,Object? type = null,Object? startAmount = null,Object? remainingAmount = null,Object? executedAmount = null,Object? price = null,Object? postOnly = null,Object? userCancelable = null,Object? averagePrice = null,Object? orderedAt = null,Object? expireAt = null,Object? triggeredAt = freezed,Object? triggerPrice = freezed,Object? status = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'order_id')  int orderId,  String pair,  String side, @JsonKey(name: 'position_side')  String? positionSide,  String type, @JsonKey(name: 'start_amount')  String startAmount, @JsonKey(name: 'remaining_amount')  String remainingAmount, @JsonKey(name: 'executed_amount')  String executedAmount,  String price, @JsonKey(name: 'post_only')  bool postOnly, @JsonKey(name: 'user_cancelable')  bool userCancelable, @JsonKey(name: 'average_price')  String averagePrice, @JsonKey(name: 'ordered_at')  int orderedAt, @JsonKey(name: 'expire_at')  int expireAt, @JsonKey(name: 'triggered_at')  int? triggeredAt, @JsonKey(name: 'trigger_price')  String? triggerPrice,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Order() when $default != null:
return $default(_that.orderId,_that.pair,_that.side,_that.positionSide,_that.type,_that.startAmount,_that.remainingAmount,_that.executedAmount,_that.price,_that.postOnly,_that.userCancelable,_that.averagePrice,_that.orderedAt,_that.expireAt,_that.triggeredAt,_that.triggerPrice,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'order_id')  int orderId,  String pair,  String side, @JsonKey(name: 'position_side')  String? positionSide,  String type, @JsonKey(name: 'start_amount')  String startAmount, @JsonKey(name: 'remaining_amount')  String remainingAmount, @JsonKey(name: 'executed_amount')  String executedAmount,  String price, @JsonKey(name: 'post_only')  bool postOnly, @JsonKey(name: 'user_cancelable')  bool userCancelable, @JsonKey(name: 'average_price')  String averagePrice, @JsonKey(name: 'ordered_at')  int orderedAt, @JsonKey(name: 'expire_at')  int expireAt, @JsonKey(name: 'triggered_at')  int? triggeredAt, @JsonKey(name: 'trigger_price')  String? triggerPrice,  String status)  $default,) {final _that = this;
switch (_that) {
case _Order():
return $default(_that.orderId,_that.pair,_that.side,_that.positionSide,_that.type,_that.startAmount,_that.remainingAmount,_that.executedAmount,_that.price,_that.postOnly,_that.userCancelable,_that.averagePrice,_that.orderedAt,_that.expireAt,_that.triggeredAt,_that.triggerPrice,_that.status);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'order_id')  int orderId,  String pair,  String side, @JsonKey(name: 'position_side')  String? positionSide,  String type, @JsonKey(name: 'start_amount')  String startAmount, @JsonKey(name: 'remaining_amount')  String remainingAmount, @JsonKey(name: 'executed_amount')  String executedAmount,  String price, @JsonKey(name: 'post_only')  bool postOnly, @JsonKey(name: 'user_cancelable')  bool userCancelable, @JsonKey(name: 'average_price')  String averagePrice, @JsonKey(name: 'ordered_at')  int orderedAt, @JsonKey(name: 'expire_at')  int expireAt, @JsonKey(name: 'triggered_at')  int? triggeredAt, @JsonKey(name: 'trigger_price')  String? triggerPrice,  String status)?  $default,) {final _that = this;
switch (_that) {
case _Order() when $default != null:
return $default(_that.orderId,_that.pair,_that.side,_that.positionSide,_that.type,_that.startAmount,_that.remainingAmount,_that.executedAmount,_that.price,_that.postOnly,_that.userCancelable,_that.averagePrice,_that.orderedAt,_that.expireAt,_that.triggeredAt,_that.triggerPrice,_that.status);case _:
  return null;
...
class _Order extends Order {
   _Order({@JsonKey(name: 'order_id') required this.orderId, required this.pair, required this.side, @JsonKey(name: 'position_side') this.positionSide, required this.type, @JsonKey(name: 'start_amount') required this.startAmount, @JsonKey(name: 'remaining_amount') required this.remainingAmount, @JsonKey(name: 'executed_amount') required this.executedAmount, required this.price, @JsonKey(name: 'post_only') required this.postOnly, @JsonKey(name: 'user_cancelable') required this.userCancelable, @JsonKey(name: 'average_price') required this.averagePrice, @JsonKey(name: 'ordered_at') required this.orderedAt, @JsonKey(name: 'expire_at') required this.expireAt, @JsonKey(name: 'triggered_at') this.triggeredAt, @JsonKey(name: 'trigger_price') this.triggerPrice, required this.status}): super._();
...
/// Create a copy of Order
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? orderId = null,Object? pair = null,Object? side = null,Object? positionSide = freezed,Object? type = null,Object? startAmount = null,Object? remainingAmount = null,Object? executedAmount = null,Object? price = null,Object? postOnly = null,Object? userCancelable = null,Object? averagePrice = null,Object? orderedAt = null,Object? expireAt = null,Object? triggeredAt = freezed,Object? triggerPrice = freezed,Object? status = null,}) {
  return _then(_Order(
orderId: null == orderId ? _self.orderId : orderId // ignore: cast_nullable_to_non_nullable
as int,pair: null == pair ? _self.pair : pair // ignore: cast_nullable_to_non_nullable
as String,side: null == side ? _self.side : side // ignore: cast_nullable_to_non_nullable
